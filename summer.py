...
plt.xticks([])
graph=plt.bar(range(len(D)), list(D.values()), color='#ffc001', edgecolor='#c3d5e8', align='center')
plt.ylim(0, 2500)
...
D2 = hours
plt.rc('xtick', labelsize=3)
graph2=plt.bar(range(len(D2)), list(D2.values()), color='#ffc001', edgecolor='#c3d5e8', align='center')
